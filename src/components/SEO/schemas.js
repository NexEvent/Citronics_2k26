...
export function websiteSchema() {
  return {
    ...
    url:              SITE.url,
    description:      `${SITE.tagline} — ${SITE.competitionCount} competitions, ${SITE.participantCount} participants, April 7–9, 2026 at ${SITE.college}, Indore.`,
    inLanguage:       'en-IN',
...
export function organizationSchema() {
  return {
    ...
    image:            SITE.ogImage,
    description:      `${SITE.competitionCount} technical and cultural competitions, ${SITE.participantCount} student participants from across India, ${SITE.departmentCount} departments — the flagship annual fest of ${SITE.college}, Indore.`,
    email:            SITE.email,
    address:          CDGI_ADDRESS,
...
export function festEventSchema() {
  return {
    ...
    description:  `Citronics 2026 is ${SITE.tagline.toLowerCase()} hosted by ${SITE.college}, Indore. Featuring ${SITE.competitionCount} competitions across AI, robotics, coding, management, cultural performances, and more — with ${SITE.participantCount} student participants from across India over 3 action-packed days.`,
    ...
    performer: {
      ...
      name:    `Student Teams from ${SITE.departmentCount} Departments`,
    },
