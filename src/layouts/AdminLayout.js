...
// Navigation items — Admin cannot see Users page
const getNavItems = (userRole) => {
  const items = [
    { title: 'Dashboard', path: '/admin/dashboard', icon: 'tabler:layout-dashboard' },
    { title: 'Events', path: '/admin/events', icon: 'tabler:calendar-event' },
    { title: 'Analytics', path: '/admin/analytics', icon: 'tabler:chart-bar' },
    { title: 'Payments', path: '/admin/payments', icon: 'tabler:credit-card' }
  ]

  // Only Owner can see Users page
  if (isOwner(userRole)) {
    items.splice(2, 0, { title: 'Users', path: '/admin/users', icon: 'tabler:users' })
  }
