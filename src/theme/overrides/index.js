...
const Overrides = settings => {
  ...
  // Create each override individually
  const chip = MuiChip()
  const list = MuiList()
  const menu = MuiMenu()
  const tabs = MuiTabs()
  ...
  // Use spread operator instead of Object.assign to create a new object
  // This prevents circular reference issues during deep cloning
  return {
    ...chip,
    ...list,
    ...menu,
